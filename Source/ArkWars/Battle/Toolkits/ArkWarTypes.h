...
{
	Default		UMETA(DisplayName = "常规技"),
	///	=============== 锁定技 ===============
	Passive		UMETA(DisplayName = "被动技"),
	///	=============== 限定技 ===============
	OnlyOnce	UMETA(DisplayName = "限定技"),
	///	=============== 转换技 ===============
	Switch		UMETA(DisplayName = "切换技"),
	///	=============== 主公技 ===============
...
struct FOperatorCardInfo : public FTableRowBase
{
	...
	/// 用于标记初始化赋予干员相对应的技能
	UPROPERTY(EditAnywhere)
	TArray<FGameplayTag> SkillComps;
...
struct FHandCardInfo : public FTableRowBase
{
	...
	///手牌的类型标记
	UPROPERTY(EditAnywhere)
	TEnumAsByte<EHandCardType> Type;
...
USTRUCT(BlueprintType)
struct FCardEffectMapping : public FTableRowBase
{
	GENERATED_BODY()
